...
IF EXISTS (
SELECT *
FROM INFORMATION_SCHEMA.ROUTINES WHERE SPECIFIC_SCHEMA = N'Solucion_Habitacional' AND SPECIFIC_NAME = N'Insert_Vivienda')
...
AS
	...
	INSERT INTO VUSADA ([vivienda], [precio_final], [contribucion])
	VALUES (vivienda, precio_final, @contribucion)
